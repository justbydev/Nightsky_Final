...
urlpatterns = [
    ...
    path('mysearch/mycommentedit/', main.views.mycommentedit, name="mycommentedit"),
    path('mysearch/mycommentdelete/', main.views.mycommentdelete, name="mycommentdelete"),
    path('mysky/check/', main.views.check, name="check"),
    ...
    path('realmain/realcheck/', main.views.realcheck, name="realcheck"),
    ...
    path('mycommentedit/', main.views.mycommentedit, name="mycommentedit"),
    path('mycommentdelete/', main.views.mycommentdelete, name="mycommentdelete"),
